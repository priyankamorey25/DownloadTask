...
class DownloadViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        //itemDownload.append(Downlaod(title:"File 4", link: <#String#>))
    }
...
extension DownloadViewController: UITableViewDelegate,UITableViewDataSource,DownLoadTableViewCellDelegate {
